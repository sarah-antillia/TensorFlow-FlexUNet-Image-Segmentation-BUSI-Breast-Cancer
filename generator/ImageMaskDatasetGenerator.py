...
class ImageMaskDatasetGenerator:
  ...
  def generate(self, images_dir, masks_dir, output_images_dir, output_masks_dir,color=(255,255,255)): 
    
    image_files = sorted(glob.glob(images_dir + "/*).png"))
    mask_files  = sorted(glob.glob(masks_dir  + "/*)_mask.png"))
...
if __name__ == "__main__":
  try:
    images_dir   = "./Dataset_BUSI_with_GT/benign"   
    masks_dir    = "./Dataset_BUSI_with_GT/benign"


    output_dir   = "./Augmented-BUSI-Breast-Cancer/"
